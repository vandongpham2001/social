...
export class Migration1749693361347 implements MigrationInterface {
    name = 'Migration1749693361347'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "created_by" character varying, "updated_by" character varying, "deleted_by" character varying, "is_deleted" boolean NOT NULL DEFAULT false, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "username" character varying(50), "email" character varying(100) NOT NULL, "password" text NOT NULL, "first_name" character varying(100) NOT NULL, "last_name" character varying(100) NOT NULL, "dob" TIMESTAMP NOT NULL, "gender" "public"."users_gender_enum" NOT NULL, "bio" text, "avatar_url" text, "is_verified" boolean NOT NULL DEFAULT false, "verified_at" TIMESTAMP, CONSTRAINT "UQ_fe0bb3f6520ee0469504521e710" UNIQUE ("username"), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "invalidated_tokens" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "created_by" character varying, "updated_by" character varying, "deleted_by" character varying, "is_deleted" boolean NOT NULL DEFAULT false, "id" character varying NOT NULL, "expiry_time" TIMESTAMP NOT NULL, CONSTRAINT "PK_47bb9767bff72a56f353d6775f0" PRIMARY KEY ("id"))`);
